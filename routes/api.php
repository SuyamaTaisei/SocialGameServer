...
Route::post('/enhance_character', App\Http\Controllers\CharacterEnhanceController::class); //キャラ強化API
Route::post('/stamina_decrease', App\Http\Controllers\StaminaDecreaseController::class); //スタミナ消費API
...
Route::post('/present_received', App\Http\Controllers\PresentReceivedController::class); //プレゼント受け取りAPI
Route::post('/present_delete', App\Http\Controllers\PresentDeleteController::class); //プレゼント削除API
Route::post('/mission_received', App\Http\Controllers\MissionReceivedController::class); //ミッション受け取りAPI