...
Route::post('/enhance_character', App\Http\Controllers\EnhanceController::class); //キャラ強化API
...
Route::get('/stamina_auto_increase', App\Http\Controllers\StaminaAutoIncreaseController::class); //スタミナ自然回復API